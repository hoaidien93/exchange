...
@section('content')
    ...
    <div id="cmb-admin-controller">
        <a class="" href="javascript:" id="cmb-admin-controller-edit">{{ __('Edit Page') }}<i class="fa fa-pencil"></i></a>
        <a class="" href="javascript:" id="cmb-admin-controller-save">{{ __('Save Page') }}<i class="fa fa-save"></i></a>
        <a class="d-none" href="javascript:" id="cmb-admin-controller-preview">{{ __('Preview Page') }}<i class="fa fa-eye"></i></a>
        <a class="d-none" href="javascript:" id="cmb-section-add-button">{{ __('Add Section') }}<i class="fa fa-plus"></i></a>
    </div>
...
@section('script')
    ...
    <script src="{{ asset('plugins/cm-visual-editor/element-library/auction-element.js') }}"></script>
